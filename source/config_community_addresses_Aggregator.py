...
def main(config_file,                   ##0
    ...
    section = 'LOCAL_DATA'
    p_names = ['COMMUNITYADDRESSESLOCALCOPY', 'localaddresses', 'CreateCurrent','localfips']
    p_vals  = [ communityaddresslocalcopy,  localaddresses, CreateCurrent , localfips ]
